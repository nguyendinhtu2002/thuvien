      ...
      <div className="grid grid-cols-5 gap-10 mx-20 bg-gray-500 px-12 pb-12">
        <div className="col-span-3">
          <div className="grid grid-cols-2">
            <div>
              <div>Tiêu đề </div>
              <input value={data.title} className="border border-black" readOnly={!isEditing} />
            </div>
            <div>
              <div>Tác giả </div>
              <input value={data.auther} className="border border-black" readOnly={!isEditing} />
            </div>
          </div>
          <div className="pr-52">
          ...
          <div className="grid grid-cols-2">
            ...
            <div>
              <div>Số trang </div>
              <input value={data.count} className="border border-black" readOnly={!isEditing} />
            </div>
          </div>
          <div>
            <div>Thể loại</div>
